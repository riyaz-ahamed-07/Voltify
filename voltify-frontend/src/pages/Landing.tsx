...
export default function Landing() {
  ...
  // Mouse tracking radial glow for premium backdrop
        ...
        >
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
            ...
            <div className="lg:col-span-7 space-y-8">
              <div className="inline-flex items-center space-x-2 bg-white/5 backdrop-blur-md rounded-full px-4 py-1.5 border border-white/10">
              ...
              <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                <button 
                  onClick={handleGetStarted}
                  className="bg-primary text-slate-950 px-8 py-4 rounded-xl text-xs font-semibold uppercase tracking-wider hover:opacity-90 transition-all flex items-center justify-center space-x-2 hover:scale-[1.01] transform duration-150"
                >
                ...
                <Link 
                  to="/login"
                  className="border border-white/10 text-white bg-white/5 backdrop-blur-md px-8 py-4 rounded-xl text-xs font-semibold uppercase tracking-wider hover:bg-white/10 transition-all flex items-center justify-center space-x-2 hover:scale-[1.01] transform duration-150"
                >
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="glass-card rounded-2xl p-8 transition-all duration-300 group flex flex-col justify-between">
                <div>
                  <div className="w-12 h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center mb-6 group-hover:border-primary/30 transition-colors duration-200">
              ...
              <div className="relative rounded-2xl p-8 border border-white/[0.06] bg-slate-900/60 backdrop-blur-md transition-all duration-300 group flex flex-col justify-between hover:border-white/12">
                <div>
                  <div className="w-12 h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center mb-6 group-hover:border-volt-pink/30 transition-colors duration-200">
              ...
              <div className="relative rounded-2xl p-8 border border-white/[0.06] bg-slate-900/60 backdrop-blur-md transition-all duration-300 group flex flex-col justify-between hover:border-white/12">
                ...
                <div className="space-y-2">
                  <div className="flex items-center space-x-2.5 bg-slate-950/40 p-2 rounded-lg border border-white/[0.04]">
                    <span className="w-1.5 h-1.5 rounded-full bg-emerald-500" />
                    <span className="font-mono text-[11px] text-gray-300">AC calibrated to BEE 24°C</span>
                  </div>
                  <div className="flex items-center space-x-2.5 bg-slate-950/40 p-2 rounded-lg border border-white/[0.04]">
                    <span className="w-1.5 h-1.5 rounded-full bg-emerald-500" />
                    <span className="font-mono text-[11px] text-gray-300">Refrigerator calibrated to 4°C</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10 relative">
              ...
              <div className="relative z-10 flex flex-col items-center text-center group">
                <div className="w-20 h-20 rounded-2xl bg-slate-900 border border-white/[0.06] flex items-center justify-center mb-6 group-hover:border-primary/40 group-hover:scale-[1.02] transition-all duration-300">
                  <Cpu className="w-8 h-8 text-gray-400 group-hover:text-primary transition-colors duration-200" />
                </div>
              ...
              {/* Step 3 */}
              <div className="relative z-10 flex flex-col items-center text-center group">
                <div className="w-20 h-20 rounded-2xl bg-slate-900 border border-primary/20 flex items-center justify-center mb-6 group-hover:scale-[1.02] transition-all duration-300">
